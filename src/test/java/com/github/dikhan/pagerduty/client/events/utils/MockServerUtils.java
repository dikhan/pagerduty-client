...
public class MockServerUtils {
     ...
     */
    public static void prepareMockServerToReceiveGivenEventAndReplyWithSuccessfulResponse(MockServerClient mockServerClient, PagerDutyEvent event, EventResult eventResult) throws JsonProcessingException {
     ...
     * @throws JsonProcessingException
     */
    public static void prepareMockServerToReceiveGivenEventAndReplyWithAcceptedResponse(MockServerClient mockServerClient, PagerDutyEvent event, EventResult eventResult) throws JsonProcessingException {
     ...
     * @throws JsonProcessingException
     */
    public static void prepareMockServerToReceiveEventAndReplyWithWithErrorResponse(MockServerClient mockServerClient, PagerDutyEvent event, EventResult eventResult) throws JsonProcessingException {
     ...
     * @throws JsonProcessingException
     */
    public static void prepareMockServerWithInternalServerErrorResponse(MockServerClient mockServerClient, PagerDutyEvent event) throws JsonProcessingException {
        String noContentResponseBody = "{}";
    ...
    private static void prepareMockServer(MockServerClient mockServerClient, PagerDutyEvent event, int statusCode, String responseBody) throws JsonProcessingException {
        ...
        mockServerClient
                .when(request()
                                .withMethod("POST")
                                .withPath(endpoint)
                                .withBody(exact(mapper.writeValueAsString(event))),
                        exactly(1))
                .respond(response()
